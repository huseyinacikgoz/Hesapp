const CACHE_NAME = 'hesapp-v1.3.98';
const URLS_TO_CACHE = [
  './',
  'index.html',
  'css/style.css',
...
self.addEventListener('install', event => {
  console.log('[Service Worker] Installing v1.3.98...');
...
self.addEventListener('activate', event => {
  console.log('[Service Worker] Activating v1.3.98...');
  ...
  event.waitUntil(
    caches.keys().then(cacheNames => {
      return Promise.all(
        ...
        console.log('[Service Worker] v1.3.98 is now active');
      });
    })
  );
